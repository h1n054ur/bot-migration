...
def get_message_logs_api(limit=20) -> tuple[list, str | None]:
...
def delete_message_api(message_sid: str) -> tuple[bool, str | None]:
    """Delete a message using Twilio API.
    ...
    """
    try:
        message = client.messages(message_sid).delete()
        return True, None
    except Exception as e:
        return False, str(e)
