...
def get_account_info_api() -> tuple[dict, str | None]:
...
def list_subaccounts_api() -> tuple[list, str | None]:
...
def list_api_keys_api() -> tuple[list, str | None]:
...
def list_sip_trunks_api() -> tuple[list, str | None]:
...
def list_twiml_apps_api() -> tuple[list, str | None]:
